...
which can be operated on fully. The [library chart](../chap03/library_charts.md) provides utilities or functions for the
...
functions](../chap02/charts_tips_and_tricks.md).
...
as required in the chart template by using the ['required' function](../chap02/charts_tips_and_tricks.md)
